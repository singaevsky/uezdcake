    ...
    <footer className="bg-gray-800 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* О нас */}
          <div>
            <h3 className="text-lg font-semibold mb-4">Уездный Кондитер</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/builder" className="text-gray-300 hover:text-white transition-colors">Конструктор</Link></li>
              <li><Link href="/about" className="text-gray-300 hover:text-white transition-colors">О нас</Link></li>
              <li><Link href="/delivery" className="text-gray-300 hover:text-white transition-colors">Доставка</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300 text-sm">
              <li><span className="font-medium">ИНН:</span> 7701234567</li>
              <li><span className="font-medium">КПП:</span> 770101001</li>
              <li><span className="font-medium">ОГРН:</span> 1234567890123</li>
              <li><span className="font-medium">Р/с:</span> 40817810123456789012</li>
              <li><span className="font-medium">Банк:</span> Сбербанк РФ</li>
            </ul>
          </div>
        </div>
