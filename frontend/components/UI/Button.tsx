...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    primary: 'bg-primary-color hover:bg-dark-color text-white focus:ring-primary-color',
    secondary: 'bg-secondary-color hover:bg-success-color text-white focus:ring-secondary-color',
    ...
    danger: 'bg-error-color hover:bg-red-700 text-white focus:ring-error-color'
  };
